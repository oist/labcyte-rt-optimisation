...
# Define plate IDs
ce$plateID <- ce$repl
levels(ce$plateID) <- c(rep("Q", 6), rep("R", 6), rep("S", 6), rep("T", 6))
...
plate <- rbind(
  read.table("plate6a.txt", sep = "\t", header=TRUE, stringsAsFactors=FALSE)
, read.table("plate6b.txt", sep = "\t", header=TRUE, stringsAsFactors=FALSE)
, read.table("plate6c.txt", sep = "\t", header=TRUE, stringsAsFactors=FALSE)
, read.table("plate6d.txt", sep = "\t", header=TRUE, stringsAsFactors=FALSE))
