...
plotReverseCumulatives(ce[,1:7], onePlot = TRUE)
plotReverseCumulatives(ce[,8:14], onePlot = TRUE)
plotReverseCumulatives(ce[,15:21], onePlot = TRUE)
plotReverseCumulatives(ce[,22:28], onePlot = TRUE)
plotReverseCumulatives(ce[,29:35], onePlot = TRUE)
plotReverseCumulatives(ce[,36:42], onePlot = TRUE)
plotReverseCumulatives(ce[,42:49], onePlot = TRUE, fitInRange = NULL)
plotReverseCumulatives(ce[,50:56], onePlot = TRUE, fitInRange = NULL)
plotReverseCumulatives(ce[,57:63], onePlot = TRUE, fitInRange = NULL)
plotReverseCumulatives(ce[,64:70], onePlot = TRUE, fitInRange = NULL)
```
...
annotateCTSS(ce, ah[["AH49556"]])
#annotateConsensusClusters(ce, ah[["AH49556"]])
#consensusClustersSE(ce)
