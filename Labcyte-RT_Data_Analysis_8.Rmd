...
```{r TSO_vs_tagDust_by_RTP_facet_RNA_var, fig.height=20, fig.width=10}
ggplot(colData(ce) %>% data.frame, aes(TSO, TD_rate, color=RT_PRIMERS %>% factor)) +
  geom_point() +
  geom_smooth(method = "loess") +
...
```{r TagDust_countour_var, fig.width=6, fig.height=10, warning=FALSE}
...
```{r TSO_vs_rRNA_by_RTP_facet_RNA_var, fig.height=20, fig.width=10}
ggplot(colData(ce) %>% data.frame, aes(TSO, rRNA_rate, color=RT_PRIMERS %>% factor)) +
  geom_point() +
  geom_smooth(method = "loess") +
  facet_wrap(~group+RT_PRIMERS, scales = "fixed", ncol = 6) +
...
```{r rRNA_countour_var, fig.width=6, fig.height=10, warning=FALSE}
...
```{r TSO_vs_norm_counts_by_RTP_facet_RNA_var, fig.height=20, fig.width=10}
ggplot(colData(ce) %>% data.frame, aes(TSO, libSizeNormBylib, color=RT_PRIMERS %>% factor)) +
  geom_point() +
  geom_smooth(method = "loess") +
  facet_wrap(~group+RT_PRIMERS, scales = "fixed", ncol = 6) +
...
```{r yield_countour_var, fig.width=6, fig.height=10, warning=FALSE}
...
```{r TSO_vs_mapping_rate_by_RTP_facet_RNA_var, fig.height=20, fig.width=10}
ggplot(colData(ce) %>% data.frame, aes(TSO, mapping_rate, color=RT_PRIMERS %>% factor)) +
  geom_point() +
  geom_smooth(method = "loess") +
  facet_wrap(~group+RT_PRIMERS, scales = "fixed", ncol = 6) +
...
```{r mapRate_countour_var, fig.width=6, fig.height=10, warning=FALSE}
...
```{r TSO_vs_SI_rate_by_RTP_facet_RNA_var, fig.height=20, fig.width=10}
ggplot(colData(ce) %>% data.frame, aes(TSO, strand_invasion_rate, color=RT_PRIMERS %>% factor)) +
  geom_point() +
  geom_smooth(method = "loess") +
  facet_wrap(~group+RT_PRIMERS, scales = "fixed", ncol = 6) +
...
```{r SI_countour_var, fig.width=6, fig.height=10, warning=FALSE}
...
```{r TSO_vs_promoter_rate_by_RTP_facet_RNA_var, fig.height=20, fig.width=10}
ggplot(colData(ce) %>% data.frame, aes(TSO, promoter_rate, color=RT_PRIMERS %>% factor)) +
  geom_point() +
  geom_smooth(method = "loess") +
  facet_wrap(~group+RT_PRIMERS, scales = "fixed", ncol = 6) +
...
```{r promRate_countour_var, fig.width=6, fig.height=10, warning=FALSE}
...
```{r TSO_vs_richness10_by_RTP_facet_RNA_var, fig.height=20, fig.width=10}
ggplot(colData(ce) %>% data.frame, aes(TSO, r10g, color=RT_PRIMERS %>% factor)) +
  geom_point() +
  geom_smooth(method = "loess") +
...
```{r richness10_contour_var, fig.width=6, fig.height=10, warning=FALSE}
