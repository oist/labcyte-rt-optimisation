...
platetools::raw_map(plate$TSO, well=plate$Well, plate="384") +
  ggtitle("TSO concentration") +
  viridis::scale_fill_viridis(trans = "log", breaks = unique(plate$TSO))
```

```{r plot_TSO_volume}
platetools::raw_map(plate$TSO_vol, well=plate$Well, plate="384") +
  ggtitle("TSO volume") +
...
```{r plot_H20_vol}
platetools::raw_map(plate$H2O_vol, well=plate$Well, plate="384") +
  ggtitle("H20 volume") +
...
platetools::raw_map(plate$RT_PRIMERS, well=plate$Well, plate="384") +
  ggtitle("RT primer concentration") +
  viridis::scale_fill_viridis(breaks = unique(plate$RT_PRIMERS), trans = "log")
```

```{r plot_RT_volume}
platetools::raw_map(plate$RT_PRIMERS_vol, well=plate$Well, plate="384") +
...
```{r plot_RNA_mass}
platetools::raw_map(plate$RNA, well=plate$Well, plate="384") +
  ggtitle("RNA mass (ng)") +
  viridis::scale_fill_viridis(breaks = unique(plate$RNA), trans = "log")
```

```{r plot_RNA_vol}
platetools::raw_map(plate$RNA_vol, well=plate$Well, plate="384") +
  ggtitle("RNA volume") +
