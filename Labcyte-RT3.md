---
title: "RT optimisation with the Labcyte Echo 525 (3rd plate design)"
output: 
  html_document: 
    fig_height: 5.25
    fig_width: 5.25
...
In the experiment number 4, we replaced some TSOs (number 8~15) with new
ones (number 71~77) to test if they were the cause of the low values observed
in any experiment originating from row B in the TSO source plate, regardless
of the TSO concentration.
...
plate %<>%
  ...
  set_block("B01", "BARCODE_ID", 71) %>%
  set_block("B02", "BARCODE_ID", 72) %>%
  set_block("B03", "BARCODE_ID", 73) %>%
  set_block("B04", "BARCODE_ID", 74) %>%
  set_block("B05", "BARCODE_ID", 75) %>%
  set_block("B06", "BARCODE_ID", 76) %>%
  set_block("B07", "BARCODE_ID", 77) %>%  
  set_block("B08", "BARCODE_ID", 71) %>%
  set_block("B09", "BARCODE_ID", 72) %>%
  set_block("B10", "BARCODE_ID", 73) %>%
  set_block("B11", "BARCODE_ID", 74) %>%
  set_block("B12", "BARCODE_ID", 75) %>%
  set_block("B13", "BARCODE_ID", 76) %>%
  set_block("B14", "BARCODE_ID", 77) %>%  
  set_block("B15", "BARCODE_ID", 71) %>%
  set_block("B16", "BARCODE_ID", 72) %>%
  set_block("B17", "BARCODE_ID", 73) %>%
  set_block("B18", "BARCODE_ID", 74) %>%
  set_block("B19", "BARCODE_ID", 75) %>%
  set_block("B20", "BARCODE_ID", 76) %>%
  set_block("B21", "BARCODE_ID", 77) %>% 
  set_block("L01", "BARCODE_ID", 71) %>%
  set_block("L02", "BARCODE_ID", 72) %>%
  set_block("L03", "BARCODE_ID", 73) %>%
  set_block("L04", "BARCODE_ID", 74) %>%
  set_block("L05", "BARCODE_ID", 75) %>%
  set_block("L06", "BARCODE_ID", 76) %>%
  set_block("L07", "BARCODE_ID", 77) %>% 
  set_block("O01", "BARCODE_ID", 71) %>%
  set_block("O02", "BARCODE_ID", 72) %>%
  set_block("O03", "BARCODE_ID", 73) %>%
  set_block("O04", "BARCODE_ID", 74) %>%
  set_block("O05", "BARCODE_ID", 75) %>%
  set_block("O06", "BARCODE_ID", 76) %>%
  set_block("O07", "BARCODE_ID", 77) %>% 
...
## B01  B01   B   1            350  60.0      50         71      GCTGCA        0.0              0
## B02  B02   B   2            350  60.0      50         72      GCTGTG        0.5             25
## B03  B03   B   3            350  60.0      50         73      GTACAG        1.0             25
## B04  B04   B   4            350  60.0      50         74      GTACGT        2.0             25
## B05  B05   B   5            350  60.0      50         75      GTACTC        4.0             25
## B06  B06   B   6            350  60.0      50         76      GTAGAT        8.0             25
## B07  B07   B   7            350  60.0      50         77      GTAGCA       12.0             25
## B08  B08   B   8            350  60.0      50         71      GCTGCA        0.0              0
## B09  B09   B   9            350  60.0      50         72      GCTGTG        0.5             25
## B10  B10   B  10            350  60.0      50         73      GTACAG        1.0             25
## B11  B11   B  11            350  60.0      50         74      GTACGT        2.0             25
## B12  B12   B  12            350  60.0      50         75      GTACTC        4.0             25
## B13  B13   B  13            350  60.0      50         76      GTAGAT        8.0             25
## B14  B14   B  14            350  60.0      50         77      GTAGCA       12.0             25
## B15  B15   B  15            350  60.0      50         71      GCTGCA        0.0              0
## B16  B16   B  16            350  60.0      50         72      GCTGTG        0.5             25
## B17  B17   B  17            350  60.0      50         73      GTACAG        1.0             25
## B18  B18   B  18            350  60.0      50         74      GTACGT        2.0             25
## B19  B19   B  19            350  60.0      50         75      GTACTC        4.0             25
## B20  B20   B  20            350  60.0      50         76      GTAGAT        8.0             25
## B21  B21   B  21            350  60.0      50         77      GTAGCA       12.0             25
...
## L01  L01   L   1            350  60.0      50         71      GCTGCA        0.0              0
## L02  L02   L   2            350  60.0      50         72      GCTGTG        0.5             25
## L03  L03   L   3            350  60.0      50         73      GTACAG        1.0             25
## L04  L04   L   4            350  60.0      50         74      GTACGT        2.0             25
## L05  L05   L   5            350  60.0      50         75      GTACTC        4.0             25
## L06  L06   L   6            350  60.0      50         76      GTAGAT        8.0             25
## L07  L07   L   7            350  60.0      50         77      GTAGCA       12.0             25
...
## O01  O01   O   1            350  60.0      50         71      GCTGCA        0.0              0
## O02  O02   O   2            350  60.0      50         72      GCTGTG        0.5             25
## O03  O03   O   3            350  60.0      50         73      GTACAG        1.0             25
## O04  O04   O   4            350  60.0      50         74      GTACGT        2.0             25
## O05  O05   O   5            350  60.0      50         75      GTACTC        4.0             25
## O06  O06   O   6            350  60.0      50         76      GTAGAT        8.0             25
## O07  O07   O   7            350  60.0      50         77      GTAGCA       12.0             25
...
##  1st Qu.:25.0   Class :character   1st Qu.: 0.500   1st Qu.:25.00   1st Qu.:1e-02   1st Qu.:25.0  
##  Median :42.5   Mode  :character   Median : 2.000   Median :25.00   Median :1e+00   Median :25.0  
##  Mean   :41.8                      Mean   : 3.929   Mean   :21.43   Mean   :2e+01   Mean   :22.5  
##  3rd Qu.:60.0                      3rd Qu.: 8.000   3rd Qu.:25.00   3rd Qu.:1e+01   3rd Qu.:25.0  
##  Max.   :77.0                      Max.   :12.000   Max.   :25.00   Max.   :1e+02   Max.   :25.0  
...
```r
write.table(plate, "plate3.txt", sep = "\t", quote = FALSE, row.names = FALSE)
```
...
![](Labcyte-RT3_files/figure-html/plot_TSO_concentration-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plot_TSO_volume-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plot_barcode_IDs-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plot_H2O_vol-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plot_RT_concentration-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plot_RT_volume-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plot_TSO_RT_ratio-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plot_RNA_mass-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plot_RNA_vol-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plot_RNA_group-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plate_all_concentrations-1.png)<!-- -->
...
![](Labcyte-RT3_files/figure-html/plate_all_volumes-1.png)<!-- -->
